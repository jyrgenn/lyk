...
;; TODO Char (test-is "seqencep 7" (sequencep #\Newline) nil)
...
;; TODO Char (test-is "setelt string" (let ((a "lalelu"))
;;                             (setelt a 3 #\x)
;;                             a)
;;          "lalxlu")
...
;; TODO Char (test-is "setelt string !0" (errset (setelt "" 0 #\x) nil) nil)
