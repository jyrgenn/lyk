...
(test-is "input-stream-p 3" (input-stream-p *terminal-io*) t)
...
;; time
(test-is "output-stream-p 3" (output-stream-p *terminal-io*) nil)
...
(test-is "interactive-stream-p 3" (interactive-stream-p *terminal-io*) t)
...
(test-is "open-stream-p 3" (open-stream-p *terminal-io*) t)
