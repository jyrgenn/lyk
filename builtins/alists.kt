...
fun bi_assoc(args: LispObject, key_args: Map<Symbol, LispObject>): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_assq(args: LispObject, key_args: Map<Symbol, LispObject>): LispObject {
    val (item, alist) = args2(args)
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_assoc_if(args: LispObject, key_args: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_assoc_if_not(args: LispObject, key_args: Map<Symbol, LispObject>
): LispObject {
    val (pred, alist) = args2(args)
