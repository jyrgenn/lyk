...
fun bi_table_get(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_put(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_make_table(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
    return Table(Nil)
}
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_count(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
    val table = arg1(args)
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_exists(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
    val (table, key) = args2(args)
    return tableArg(table, "table-exists").exists(key)
}

val initialKeySym = Symbol.intern("initial")
val createKeySym = Symbol.intern("create")
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_inc(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_keys(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_values(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_pairs(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
...
/// end builtin
@Suppress("UNUSED_PARAMETER")
fun bi_table_remove(args: LispObject, kwArgs: Map<Symbol, LispObject>
): LispObject {
