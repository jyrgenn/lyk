...
(test-is "fround 2.5" (fround 2.5) 3)
...
(let ((examples '(0 1 2 6 12 15 16 19 32 35 44 48 51 56 59 60 62 72 85 105 106
  ...
  (while (and examples results)
    (let ((val (pop examples))
          (res (pop results)))
      (eval `(test-is ,(format nil "isqrt %s" val) (isqrt ,val) ,res)))))
